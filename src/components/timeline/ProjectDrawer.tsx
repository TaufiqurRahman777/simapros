...
export function ProjectDrawer({ open, onOpenChange, project, isSuperAdmin, masterProyekList = [] }: ProjectDrawerProps) {
  ...
  const hasTier2Assessment = Boolean(project.current_priority_assessment_id);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (!hasTier2Assessment) updates.priority = editForm.priority;
        ...
        <div className="mt-6 space-y-5">
          {isEditing ? (
            <>
              ...
              {/* Priority legacy hanya boleh diedit sebelum assessment Tier 2. */}
              {!hasTier2Assessment && <div className="space-y-2">
