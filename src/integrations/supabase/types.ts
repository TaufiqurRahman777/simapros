  ...
  public: {
    Tables: {
      ...
      projects: {
        ...
        Relationships: [
          {
            foreignKeyName: "projects_current_priority_assessment_fkey"
            columns: ["id", "current_priority_assessment_id"]
            isOneToOne: false
            referencedRelation: "project_priority_assessments"
      ...
      project_priority_assessments: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_priority_assessments_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      record_sop2026_priority_assessment: {
        Args: {
          _edited_project?: Json
          _effort?: number | null
          _eligibility_notes?: string | null
          _evidence: Json
          _final_decision?: string | null
          _final_decision_note?: string | null
          _gates: Json
          _governance_snapshot?: Json
          _intake_snapshot?: Json
          _justifications: Json
          _mandatory_answers: Json
          _method_version?: string
          _override_reason?: string | null
          _priority_note?: string | null
          _probing_session?: Json
          _project_id: string
          _proposed_end_date?: string | null
          _proposed_start_date?: string | null
          _scores: Json
          _technical_notes?: string | null
        }
        Returns: Database["public"]["Tables"]["project_priority_assessments"]["Row"]
      }
      record_tier2_priority_assessment: {
        Args: {
          _edited_project?: Json
          _effort: number
          _eligibility_notes?: string | null
      ...
      respond_to_priority: {
        Args: { _decision: string; _project_id: string }
        Returns: undefined
      }
    }
    Enums: {
