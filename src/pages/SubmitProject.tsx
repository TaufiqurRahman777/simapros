...
export default function SubmitProject() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.from('projects').insert([{
      ...
      // Klaim pengaju masuk ke urgency_claimed. Kolom `urgency` sengaja tidak
      // diisi di sini — itu milik HTO dan ditetapkan saat evaluasi.
      urgency_claimed: formData.urgency,
    }]);
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Urgensi menurut pengaju — USULAN, bukan nilai resmi. Nilai yang
                dipakai menghitung prioritas ditetapkan HTO saat evaluasi, supaya
                klaim pengaju tidak lagi otomatis menjadi separuh penentu hasil. */}
            <div className="space-y-2">
              <Label htmlFor="urgency" className="text-base">Urgensi Menurut Anda (Usulan) *</Label>
              <Select
              ...
              <p className="text-xs text-muted-foreground">
                Pilih kondisi yang paling sesuai dengan proyek Anda. Ini adalah <strong>usulan</strong> —
                nilai urgensi resmi ditetapkan HTO saat evaluasi bersama, dan Anda akan menerima
                penjelasan dasar penilaiannya.
              </p>
            </div>
